                ...
                <table border="0" cellpadding="0" cellspacing="0" width="600" style="background-color: #FFFFFF; border-radius: 12px; overflow: hidden; border: 1px solid #E8E8E6; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05);">
                    ...
                    <tr>
                        <td style="padding: 40px 40px 30px 40px; color: #1E1E1C;">
                            <h1 style="margin: 0 0 16px 0; font-size: 20px; font-weight: 700; color: #0A0A0A; letter-spacing: -0.3px;">Support Ticket Update (#{{ $ticketId }})</h1>
                            <p style="margin: 0 0 16px 0; font-size: 14px; line-height: 1.6; color: #6B6B6B;">
                                An operator posted a response to your open support ticket:
                            </p>
                            <div style="background-color: #F5F5F5; border-left: 4px solid #4AE54A; padding: 16px 20px; border-radius: 4px; margin-bottom: 24px; font-size: 14px; line-height: 1.6; color: #1E1E1C;">
                                {!! nl2br(e($replyMessage)) !!}
                            </div>
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-bottom: 24px;">
                                <tr>
                                    <td align="center">
                                        <a href="{{ $url }}" target="_blank" style="display: inline-block; padding: 12px 32px; background-color: #0A0A0A; color: #FFFFFF; font-size: 14px; font-weight: 700; text-decoration: none; border-radius: 6px; transition: background-color 0.2s;">
                                            View Support Ticket
                                        </a>
                                    </td>
                                </tr>
                    ...
                    <tr>
                        <td style="background-color: #F9F9F8; padding: 20px 40px; border-top: 1px solid #F0F0EE; text-align: center; font-size: 11px; color: #A0A0A0;">
                            © {{ date('Y') }} WhatsOmni Support Services. All rights reserved.
                        </td>
                    </tr>
                </table>
            </td>
